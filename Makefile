...
owner:
	@forge script script/Interactions.s.sol:OwnerFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

funder:
	@forge script script/Interactions.s.sol:FunderFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

# length:
# 	@forge script script/Interactions.s.sol:GetFunderLengthFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

amountFunded:
	@forge script script/Interactions.s.sol:AmountFundedFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)
