...
# make sure this address matches the deployer $(ACCOUNT) when make withdraw
# SENDER_ADDRESS := $(ANVIL_ADDRESS)
...
balance:
	@forge script script/Interactions.s.sol:BalanceFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)
	
withdraw:
	@forge script script/Interactions.s.sol:WithdrawFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

pricefeed:
	@forge script script/Interactions.s.sol:GetPriceFeedFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

owner:
	@forge script script/Interactions.s.sol:GetOwnerFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

funder:
	@forge script script/Interactions.s.sol:GetFunderFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

length:
	@forge script script/Interactions.s.sol:GetFunderLengthFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

thefund:
	@forge script script/Interactions.s.sol:GetFundFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)